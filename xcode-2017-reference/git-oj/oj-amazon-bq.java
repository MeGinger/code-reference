...
* 你做了什么加强你和同事的联系，增加彼此的信任感
* 我被问了你有没有帮助同事解决问题的经历，你有没有觉得能比requirement做的更好的经历
* 你最成功的一次帮助别人的经验
* 怎么证明你是TeamPlayer，你为你的同事做过什么吗  这里可能会包含leadership的问题，即你做了什么能看出你在这个组中有领导能力
* Do you get feedbacks from your friends or teammate? What is it? Positive or negative? What is the negative feedback you encountered? What did you learn from it? How did you feel when heard negative feedback?
* how do you deal with other people’s bad feedback
* 你有没有被人指责过，你是怎么做的？
* 你有没有遇到过你和你的teammate有不同的想法，最后发现其实是你的想法错了，你怎么解决的？

Q: Show a project where you need to collaborate with multiple teams
A: CRISP data migration
...
你遇到的最难缠的customer，以及怎么解决问题

* Deadline *
Can't meet deadline                                                            
Experience: project approaching to deadline
你有没有在时限很短的情况下完成一个项目，你是怎么调节你的时间的，你是否因此必须牺牲什么？
有时候碰到deadline快到，但是项目遇到问题有可能做不完，怎么处理.
如果有一个很紧张的project， 你有如下方法解决, 用些手段（hacky) 赶上timeline,用正常手法，但是赶不上了
Can't meet deadline
Manager: deadline can’t be met how did you escalate
...
Dive deep project （问了三次）
Most proud project （问了两次）
What did you do proudly
你最proud of的一个项目是什么
Describe a project that you think is most interesting or you feel very proud of? What did you learn from it?
Describe a situation that you have done a lot on the project, but you find your method for the problem is not good, how would you deal with that ? 
